...
## Needed context
During my first year of studies in Computer Engineering, a friend bet me I couldn't build a neural network from scratch (without any libraries) in a single week. I had a few hours to kill, so here we are.
